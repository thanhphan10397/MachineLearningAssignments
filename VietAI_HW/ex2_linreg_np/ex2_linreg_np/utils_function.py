...
def check_if_arrays_equal(act_arr, exp_arr):
    """
    ...
    Returns:
      True/False
    """
    #count elements of the expected array
    expected_num = len(exp_arr)
    #count number of elements that have approximate values in 2 arrays
    actual_num = np.sum(np.isclose(act_arr, exp_arr))
    #check if elements of the actual & expected arrays are approximate
